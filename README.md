...
> you should change your keymappings to call the text objects via Ex-commands `"<cmd>lua require('various-textobjs')." .textobj(true)<CR>",`. This makes the text objects dot-repeatable. See the example in the [Configuration Section](#configuration).
